      ...
      return {
        ...
        pre: (props) => {
          ...
          if (
            ...
            const toCodeLanguage = (value?: string): string | undefined => {
              if (!value) {
                return undefined;
              }

              if (isSpecialLang(value as SpecialLanguage)) {
                return value;
              }

              if (value in bundledLanguages) {
                return value;
              }
            ...
            return <CodeBlock code={firstChild.children[0].value} language={toCodeLanguage(rawLanguage)} {...rest} />;
          }
